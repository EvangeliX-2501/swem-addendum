package com.evangelix.swemaddendumplus.breeds.arabian;
...
public class ArabianModelProvider extends AbstractSteedModelProvider {
    ...
    public static final ResourceLocation ADULT_MODEL = new ResourceLocation(SwemAddendumPlusMain.MODID, "geo/swem_arabian.geo.json");
