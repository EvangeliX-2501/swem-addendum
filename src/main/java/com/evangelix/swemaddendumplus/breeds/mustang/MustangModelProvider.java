package com.evangelix.swemaddendumplus.breeds.mustang;
...
public class MustangModelProvider extends AbstractSteedModelProvider {
    ...
    public static final ResourceLocation ADULT_MODEL = new ResourceLocation(SwemAddendumPlusMain.MODID, "geo/swem_mustang.geo.json");
