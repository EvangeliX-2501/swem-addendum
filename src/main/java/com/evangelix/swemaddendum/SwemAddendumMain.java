...
import com.evangelix.swemaddendum.item.TextureItem;
...
public class SwemAddendumMain
{
    ...
    public static final RegistryObject<EntityType<IrishDraught>> IRISH_DRAUGHT = registerSteed("irish_draught", IrishDraught::new);
    ...
    public static final RegistryObject<TextureItem> STICK_OF_ACKNOWLEDGEMENT = ITEMS.register("stick_of_acknowledgement", TextureItem::new);
