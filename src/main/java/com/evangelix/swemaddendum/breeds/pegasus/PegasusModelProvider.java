...
public class PegasusModelProvider extends AbstractSteedModelProvider {
    ...
    public static final ResourceLocation ADULT_MODEL = ResourceLocation.fromNamespaceAndPath(SwemAddendumMain.MODID, "geo/swem_pegasus.geo.json");
