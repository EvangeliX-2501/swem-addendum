...
public class BretonModelProvider extends AbstractSteedModelProvider {
    ...
    public static final ResourceLocation ADULT_MODEL = ResourceLocation.fromNamespaceAndPath(SwemAddendumMain.MODID, "geo/swem_breton.geo.json");
