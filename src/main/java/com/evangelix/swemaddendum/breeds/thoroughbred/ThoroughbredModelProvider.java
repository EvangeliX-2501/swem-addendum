...
public class ThoroughbredModelProvider extends AbstractSteedModelProvider {
    ...
    public static final ResourceLocation ADULT_MODEL = ResourceLocation.fromNamespaceAndPath(SwemAddendumMain.MODID, "geo/swem_thoroughbred.geo.json");
