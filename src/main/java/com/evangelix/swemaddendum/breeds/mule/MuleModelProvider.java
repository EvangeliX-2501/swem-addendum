...
public class MuleModelProvider extends AbstractSteedModelProvider {
    public static final ResourceLocation FOAL_MODEL = ResourceLocation.fromNamespaceAndPath(SwemAddendumMain.MODID, "geo/foal/mule_foal.geo.json");
    public static final ResourceLocation ADULT_MODEL = ResourceLocation.fromNamespaceAndPath(SwemAddendumMain.MODID, "geo/swem_mule.geo.json");
